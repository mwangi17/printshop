...
<head>
  ...
  <link href="style.css?version=51" rel="stylesheet" type="text/css">
...
<body class="bod">
  <h3>Offering prints at
    affordable rates<br>
    Order from anywhere...<br>
  Placing your Order <br>
  is now more convenient, <br>and easy.</h3>
...
<div>
  <ul class="con-ul">
    <li>Contact Us
    <li>onlineW2P situated at ngong road</li></li>
  </ul>
</div>
-->
</body>
